...
public class XrayJsonReporterConfig implements IReporter {
     ...
     */
    private String summary = "Test Run results " + LocalDateTime.now().format(DateTimeFormatter.ofPattern("MM.dd.yyyy HH:mm"));
...
//    }
    ...
    public String getTestPlanKey() {
        testPlanKey = System.getProperty("mtestplan");
        if (testPlanKey == null) testPlanKey = "";
        return testPlanKey;
    }
